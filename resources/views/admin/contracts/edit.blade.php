                                    ...
                                    <label class="label">
                                        ...
                                        <select class="select2" name="owner" data-action="{{ route('admin.contracts.getDataOwner') }}">
                                            ...
                                            @foreach ($lessors->get() as $lessor )
                                                <option value="{{$lessor->id}}" {{ (old('owner') == $lessor->id ? 'selected' : ($contract->owner == $lessor->id ? 'selected' : '')) }}>
                                                    {{$lessor->name}} ({{$lessor->document}})</option>
                                            @endforeach
                                        </select>
                                    </label>
                                    ...
                                    <label class="label">
                                        ...
                                        <select name="acquirer" class="select2" data-action="{{ route('admin.contracts.getDataAcquirer') }}">
                                            ...
                                            @foreach ($lessees->get() as $lessee )
                                                <option value="{{$lessee->id}}" {{ (old('acquirer') == $lessee->id ? 'selected' : ($contract->acquirer == $lessee->id ? 'selected' : '')) }}>
                                                    {{$lessee->name}} ({{$lessee->document}})</option>
                                            @endforeach
                                        </select>
                                    </label>
                            ...
                            <div class="app_collapse_content">
                                ...
                                <div class="label_g2">
                                    <label class="label">
                                        ...
                                        <input type="tel" name="sale_price" class="mask-money" placeholder="Valor de Venda"
                                    ...
                                    <label class="label">
                                        ...
                                        <input type="text" name="rent_price" class="mask-money" placeholder="Valor de Locação"
            ...
            if(response.companies != null && response.companies.length){
                ...
                $.each(response.companies, function (key, value) {
                    $('select[name="owner_company"]').append($('<option>', {
                        ...
                        selected: ( $('input[name="owner_company_persist"]').val() == value.id ? 'selected' : false)
                    }));
                });
