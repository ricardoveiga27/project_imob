                ...
                <div class="nav_tabs_content">
                        ...
                        <div class="label_g2">
                            <label class="label">
                                ...
                                <select name="status" class="selct">
                                    <option value="1" {{ (old('status') == '1' ? 'selected' : '')) }}>Disponivel</option>
                                    <option value="0" {{ (old('status') == '0' ? 'selected' : ''))}}>Indisponivel</option>
                                </select>
                            </label>
                        </div>
                    ...
                    <div id="structure" class="d-none">
                        ...
                        <div class="label_g5">
                            ...
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="balcony" {{ (old('balcony') == 'on' || old('balcony') == true ? 'checked' : '') }}><span>Varanda</span>
                                </label>
                            </div>
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="gourmet_balcony" {{ (old('gourmet_balcony') == 'on' || old('gourmet_balcony') == true ? 'checked' : '') }}><span>Varanda Gourmet</span>
                                </label>
                            </div>
                        </div>
                    </div>
