            ...
            <form action="{{ route('admin.properties.update', ['property' => $property->id]) }}" method="post" class="app_form" enctype="multipart/form-data">
                ...
                <div class="nav_tabs_content">
                    <div id="data">
                        ...
                        <div class="label_g2">
                            <label class="label">
                                ...
                                <select name="category" class="select2">
                                    ...
                                    <option value="Comercial/Industrial" {{ (old('category') == 'Comercial/Industrial'  ? 'selected' : ($property->category == 'Imóvel Comercial/Industrial' ? 'selected' : '')) }}>Comercial/Industrial</option>
                            ...
                            <label class="label">
                                ...
                                <select name="type" class="select2">
                                    ...
                                    <optgroup label="Comercial/Industrial">
                                        ...
                                        <option value="Ponto Comercial" {{ (old('type') == 'Ponto Comercial'  ? 'selected' : ($property->ctype == 'Ponto Comercial' ? 'selected' : '')) }} >Ponto Comercial</option>
                                    </optgroup>
                        ...
                        <div class="label_g2">
                            <label class="label">
                                <span class="legend">Status: {{ $property->status}}</span>
                                <select name="status" class="selct">
                                    <option value="1" {{ (old('status') == '1' ? 'selected' : ($property->status == true ? 'selected' : '')) }}>Disponivel</option>
                                    <option value="0" {{ (old('status') == '0' ? 'selected' : ($property->status == false ? 'selected' : ''))}}>Indisponivel</option>
                                </select>
                            </label>
                        </div>
                    ...
                    <div id="structure" class="d-none">
                        ...
                        <div class="label_g5">
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="air_conditioning" {{ (old('rent') == 'on' || old('rent') == true ? 'checked' : ($property->air_conditioning == true ? 'checked' : '')) }}><span>Ar Condicionado</span>
                                </label>
                            </div>
                            <div>
                                <label class="label">
                            ...
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="balcony" {{ (old('balcony') == 'on' || old('balcony') == true ? 'checked' : ($property->balcony == true ? 'checked' : '')) }}><span>Varanda</span>
                                </label>
                            </div>
                            <div>
                                <label class="label">
                                    <input type="checkbox" name="gourmet_balcony" {{ (old('gourmet_balcony') == 'on' || old('gourmet_balcony') == true ? 'checked' : ($property->gourmet_balcony == true ? 'checked' : '')) }}><span>Varanda Gourmet</span>
                                </label>
                            </div>
                        </div>
                    </div>
