...
class Property extends Model
{
    ...
    {
        $this->attributes['balcony'] = (($value === true || $value === 'on') ? 1 : 0);
    }


    public function setGourmetBalconyAttribute($value)
    {
        $this->attributes['gourmet_balcony'] = (($value === true || $value === 'on') ? 1 : 0);
    }
     ...
     public function convertStringToDouble(?string $param)
    {
        if(empty($param)){
            return '';
        }
